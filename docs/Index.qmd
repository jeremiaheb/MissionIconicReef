...
MIR_LF_yr(df = MIR_data, spp = "hae flav", bin_size = 5, yrs = c(2022, 2024), spp_name = "French grunt", category = "M:IR", custom_title = "French Grunt - M:IR")
MIR_LF_yr(df = MIR_data, spp = "hae flav", bin_size = 5, yrs = c(2022, 2024), spp_name = "French grunt", category = "open", custom_title = "French Grunt - Open")
```
...
MIR_LF_yr(df = MIR_data, spp = "spa viri", bin_size = 5, yrs = c(2022, 2024), spp_name = "Stoplight Parrotfish", category = "M:IR", custom_title = "Stoplight Parrotfish - M:IR")
MIR_LF_yr(df = MIR_data, spp = "spa viri", bin_size = 5, yrs = c(2022, 2024), spp_name = "Stoplight Parrotfish", category = "open", custom_title = "Stoplight Parrotfish - Open")
```
...
MIR_LF_yr(df = MIR_data, spp = "sca guac", bin_size = 5, yrs = c(2022, 2024), spp_name = "Rainbow Parrotfish", category = "M:IR", custom_title = "Rainbow Parrotfish - Open")
MIR_LF_yr(df = MIR_data, spp = "sca guac", bin_size = 5, yrs = c(2022, 2024), spp_name = "Rainbow Parrotfish", category = "open", custom_title = "Rainbow Parrotfish - Open")
```
...
MIR_LF_yr(df = MIR_data, spp = "ste plan", bin_size = 5, yrs = c(2022, 2024), spp_name = "3-Spot Damselfish", category = "M:IR", custom_title = "3-Spot Damselfish - MIR")
MIR_LF_yr(df = MIR_data, spp = "ste plan", bin_size = 5, yrs = c(2022, 2024), spp_name = "3-Spot Damselfish", category = "open", custom_title = "3-Spot Damselfish - Open")
```
...
MIR_LF_yr(df = MIR_data_copy, spp = "CAL NODO", bin_size = 5, yrs = c(2022, 2024), spp_name = "Porgy", category = "M:IR", custom_title = "Porgy - MIR")
MIR_LF_yr(df = MIR_data_copy, spp = "CAL NODO", bin_size = 5, yrs = c(2022, 2024), spp_name = "Porgy", category = "open", custom_title = "Porgy - Open")
```
...
MIR_LF_yr(df = MIR_data, spp = "epi mori", bin_size = 5, yrs = c(2022, 2024), spp_name = "Red Grouper", category = "M:IR", custom_title = "Red Grouper - MIR")
MIR_LF_yr(df = MIR_data, spp = "epi mori", bin_size = 5, yrs = c(2022, 2024), spp_name = "Red Grouper", category = "open", custom_title = "Red Grouper - Open")
```
