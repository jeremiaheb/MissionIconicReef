...
[Mission: Iconic Reefs](https://missioniconicreefs.org/) is a multi-institutional initiative designed to restore ecological function and biodiversity across ‘iconic’ reef sites in the Florida Keys. Led by NOAA in collaboration with federal, state, institutional, academic, and non-profit partners, M:IR targets nearly three million square feet of reef at seven coral reefs in the Florida Keys National Marine Sanctuary (FKNMS): Carysfort (North and South), Horseshoe Reef, Cheeca Rocks, Sombrero Reef, Newfound Harbor, Looe Key, and Eastern Dry Rocks. The overarching M:IR goal is to restore coral cover and reef function to a self-sustaining state.
...
```{r, echo=FALSE, results='asis', out.width='80%', fig.align='center', fig.cap="Map of the Florida Keys showing the sites of Mission: Iconic Reefs"}
if (knitr::is_html_output()) {
  cat('
  <figure style="text-align: center;">
    <img src="MIRmap.png" alt="Map of the Florida Keys showing the sites of Mission: Iconic Reefs" width="100%" style="margin-top: 1em;">
    <figcaption style="margin-top: 0.5em; font-style: italic;">
      Map of the Florida Keys showing the sites of Mission: Iconic Reefs
    </figcaption>
  </figure>
  ')
} else {
...
target_species <- c(
  ...
  "CAL CALA", "CAL NODO", "OCY CHRY", "LAC MAXI"
)
...
Relative density is an index or relative measure of population density that is commonly used in fisheries surveys. Relative density is a comparative measure of density across locations or years, rather than an absolute count that is impractical due to the scale and complexity of the marine environment. Densities shown here represent NCRMP’s fish survey area (177m2; [@CRCP2024]).
...
MIR_domain_dens_by_year(MIR_data_merged, spp_list_merged, caption = str_wrap( 
                        "Relative density results are shown as the number of individuals per survey area 177 m² ± standard error\n within the M:IR reef sites (M:IR, green) and outside the restoration areas in the Florida Keys (outside, blue). Significant differences between M:IR and outside densities are denoted with an asterisk (*) within each survey year.", width = 100))
```
...
MIR_domain_occ_by_year(MIR_data_merged, spp_list_merged, caption = str_wrap(
                        "Relative occurrence ± standard error is shown within the M:IR reef sites (M:IR, green) and outside the restoration areas in the Florida Keys (outside, blue). Significant differences between M:IR and outside densities are denoted with an asterisk (*) within each survey year.", width = 100))
```
