...
This data set represents sample locations in the Florida Keys. Only those strata types found within the MIR areas were considered (table 1).
...
```{r}
MIR_domain_dens_barplot(MIR_data, year = 2022, species = spp_list)
```

## Occurrence

```{r}
MIR_domain_occ_barplot(MIR_data, year = 2022, species = spp_list)
```
