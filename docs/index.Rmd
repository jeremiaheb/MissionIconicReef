...
## Occurrence
Survey occurrence within MIR sites and sites in the Florida Keys. 
```{r}
MIR_domain_occ_by_year(MIR_data, spp_list)
```

## Length Frequency {.tabset}
Number of individuals counted within size bins for surveys within MIR sites and outside. 
